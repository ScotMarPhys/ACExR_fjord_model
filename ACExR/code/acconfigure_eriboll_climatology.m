...
% MSL.
 Param.SHFlux = 1;
 Bdata.SHF_file = '../in/Climatology_heatflux_Dunstaffnage_1970-2004.csv';
...
% 1. Wind data
 Param.WindData = 1;
 Bdata.Wind_file = '../in/Climatology_windspeed_1970-2004.csv';
...
% 2a. Rainfall data
 Param.QfData = 1;
 Bdata.Qf_file = '../in/Revised_climatology_rainfall_1970-2006.csv';
...
% 3. Boundary T & S data
Param.OBdata = 1;
Bdata.OB_file = '../in/ukhoclimatology (edit).csv';
