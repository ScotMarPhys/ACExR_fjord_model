...
% Phil Gillibrand
% June 2010
% Modified to include high mixing convective overturning, March 2016
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
else% DelS < 0, unstable water column
    % Convective overturning.
    % Kz specified to overturn the two layers in two days.
%     KZ = DiffZ * DiffZ / (2 * 86400); 
    % Kz specified to overturn the whole water column in four days (Rippeth & Simpson, 1996).
    KZ = sum(D.H)^2 / (4 * 86400); 
    % Default value
%      KZ = 0.01; %m2/s
    disp(['Overturning: Kz12 = ', num2str(KZ,'%8.6f'),' m2/s']);
end
